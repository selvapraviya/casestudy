...
public class ksrtc {
  ...
  public void f() throws InterruptedException {
	  System.setProperty("webdriver.chrome.driver","C:\\Users\\selvapraviya.s\\Downloads\\chromedriver_win32\\chromedriver.exe");
		WebDriver w;
		w = new ChromeDriver();
	w.get("https://ksrtc.in/oprs-web/");
	w.manage().window().maximize();
	login.Signin(w).click();
	login.Username(w).sendKeys("selvapraviya23@gmail.com");
	login.Password(w).sendKeys("sel@123");
	login.Login(w).click();
